...
$recipient_id = filter_input( INPUT_GET, 'id', FILTER_SANITIZE_NUMBER_INT );
if ($recipient_id) {
	try {
		$result = ImcConnector::getInstance()->selectRecipientData($credentials['imc']['database_id'], $recipient_id);
