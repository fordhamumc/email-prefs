...
/**
 * This is a basic class for connecting to the Imc API
 * @author Mark French, Argyle Social
 */
class ImcRestConnector extends ImcBaseConnector {
	...
	public function authenticate($clientId=null, $clientSecret=null, $refreshToken=null) {
		...
		if (empty($result['access_token'])) {
			...
			throw new ImcConnectorException($msg);
		}
	...
	protected function post($resource, $params=array()) {
		...
		if (empty($accessToken)) {
			throw new ImcConnectorException('Unable to authenticate request.');
		}
